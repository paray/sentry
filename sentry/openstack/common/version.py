...
class VersionInfo(object):
    ...
    def __init__(self, package, python_package=None, pre_version=None):
        ...
        :param package: name of the top level python namespace. For sentry,
                        this would be "sentry" for python-novaclient, it
                        would be "novaclient"
        :param python_package: optional name of the project name. For
                               sentry this can be left unset. For
                               python-novaclient, this would be
                               "python-novaclient"
