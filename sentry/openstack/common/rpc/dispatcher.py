...
API as an example.  The client side is in sentry/compute/rpcapi.py and the server
side is in sentry/compute/manager.py.


Example 1) Adding a new method.

Adding a new method is a backwards compatible change.  It should be added to
sentry/compute/manager.py, and RPC_API_VERSION should be bumped from X.Y to
X.Y+1.  On the client side, the new method in sentry/compute/rpcapi.py should
...
RPC_API_VERSION on the server side (sentry/compute/manager.py) should be bumped.
